...
export default function SignUp() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        else router.push('/auth/signin?message=Revisa tu email para confirmar')
    }

    return (
        <div className="flex min-h-screen flex-col md:flex-row">
            {/* Columna izquierda - Branding (misma que signin) */}
            ...
            <div className="flex items-center justify-center p-6 md:w-1/2 dark:bg-gray-900">
                <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl dark:bg-gray-800 dark:text-white">
                    <h2 className="mb-6 text-2xl font-semibold">Crear cuenta</h2>
                    {error && (
                    ...
                    <div className="mt-6 text-center text-xs text-gray-500 dark:text-gray-500">
                        © 2026 Spendly. Todos los derechos reservados.
                    </div>
                </div>
            </div>
        </div>
